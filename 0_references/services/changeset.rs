...
use locus_code_shared::models::integrations::openai::ToolCall;
...
impl Changeset {
    ...
    pub fn track_file(&mut self, path: &str, edit: FileEdit) {
        ...
        let is_creation = edit.tool_call.as_ref().is_some_and(|tc| {
            ...
            name == "locus_code__create"
                || name == "locus_code__write"
                || name == "locus_code__create_file"
                || name == "create"
                || name == "create_file"
        });
    ...
    fn apply_reverse_edit(content: &str, tool_call: &ToolCall) -> Result<String, String> {
        ...
        if tool_call.function.name != "locus_code__str_replace" {
        ...
        changeset.track_file(
            ...
            FileEdit::new("Initial creation".to_string())
                ...
                .with_tool_call(ToolCall {
                    ...
                    function: locus_code_shared::models::integrations::openai::FunctionCall {
                        name: "locus_code__create".to_string(),
                        arguments: "{}".to_string(),
                    },
                }),
        );
