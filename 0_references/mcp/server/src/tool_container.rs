...
use locus_code_shared::remote_connection::RemoteConnectionManager;
use locus_code_shared::secret_manager::SecretManager;
use locus_code_shared::task_manager::TaskManagerHandle;
use std::sync::Arc;
...
impl ServerHandler for ToolContainer {
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            ...
            instructions: Some("The LocusCode MCP server.".to_string()),
        }
    }
