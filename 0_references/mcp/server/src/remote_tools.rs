...
use locus_code_api::models::{
    SearchDocsRequest as ApiSearchDocsRequest, SearchMemoryRequest as ApiSearchMemoryRequest,
};
use locus_code_shared::utils::{handle_large_output, sanitize_text_output};
// use locus_code_api::models::CodeIndex;
// use locus_code_shared::local_store::LocalStore;
// use locus_code_shared::models::indexing::IndexingStatus;
// use tracing::error;
