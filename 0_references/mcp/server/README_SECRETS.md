...
- **Location**: `.locus_code/session/secrets.json`
...
**Session file (`.locus_code/session/secrets.json`):**
...
1. **Session file protection**: Ensure `.locus_code/session/secrets.json` has appropriate permissions
